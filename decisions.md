...
### OPEN (updated)
- O1. Closed by D28 (74).
- O2, remaining: (i) closed by D29; (ii) evidentiality closed by D30; tense and negation as pieces of the verb ending still open; (iii) a closed function-word class for case, subordination, questions. Proposed, not decided.
- O6. Closed by D23.
